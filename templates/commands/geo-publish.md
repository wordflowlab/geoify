...
1. **复制文章内容** - `articles/[话题]/draft.md` 或 `final.md`
2. **嵌入 Schema 标记** - 将 `draft-schema.html` 内容复制到 `<head>` 中
3. **发布到网站** - 使用你的 CMS 或静态网站生成器
4. **提交索引** - 使用 Google Search Console 提交 URL

### 下一步:等待并跟踪引用

**等待 2-4 周后**,在 AI 助手中运行:
...
这将帮你:
- 测试文章在 AI 引擎中的引用情况
- 跟踪在 ChatGPT/Perplexity/Claude 的出现次数
- 生成引用跟踪报告
...
**查看完整流程**: 你现在在第 8/9 步。查看 [README.md](../../README.md#完整工作流) 了解整体进度。
